...
Relevant paths, symbols and inputs: Only what this job needs.
Dependencies already satisfied: Artifact identity from an earlier job (path, snapshot or evidence result), or none.
