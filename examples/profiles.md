...
| `balanced` | Current AMC default | Direct for understood work. Use a specialist when focused expertise or a fresh context earns its cost. Parallel workers require independent jobs, host isolation and compact artifacts. Review by risk, not by habit. |
