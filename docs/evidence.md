...
| [Engineering validation](development.md#run-local-engineering-checks) | Checks cover structure, the Truth Layer contract, package integrity, fixtures, preservation, accounting and replay tooling. | Passing tooling tests is not proof of an agent's behavior on your project. |
