...
| **0.2.0-candidate.16** | Branch [`claude/candidate-16`](https://github.com/byensitmagnus/agent-mission-control/tree/claude/candidate-16); no tagged ZIP yet. | A fixed report template with one `Status:` line and explicit `Delegation:` and `Review:` fields. [Haiku smoke](../evals/haiku-smoke-2026-09-25.md#candidate16-smoke-2026-09-26): case 08 passed 2/3, case 03 supplied a delegation reason in 2/3 (0/3 on candidate.15), and case 09 passed 1/1. One case 08 run still reported PASS without independent review. Runtime SHA-256 `267028bf…55b79fa34`. Independent read-only review on 2026-09-26 rejected the original R4 release claim; a limited report-format beta is under consideration, not released. |
| **v0.2.0-candidate.15** | [Tagged ZIP (latest release)](https://github.com/byensitmagnus/agent-mission-control/releases/tag/v0.2.0-candidate.15), with skill/plugin checksums. | Closes candidate.14's four deferred review points; a review the agent wrote itself does not count; final reports name delegation; `validate.py` enforces the size budget ([PRD](prd.md) R7). [Smoke](../evals/haiku-smoke-2026-09-25.md#candidate15-smoke-2026-09-26): the migration case passed in 1 of 3 Haiku runs, where one run started an independent reviewer on its own, and in the Sonnet run, whose reviewer found a real bug; the routing line was written in 0 of 3 Haiku runs of case 03. Released runtime SHA-256 `481288ca…75379a41`. |
