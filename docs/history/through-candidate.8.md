...
[research basis](../research-basis.md) distinguishes published results, platform
...
The [engineering record](../engineering-candidate.8.md) and
[host guide](../hosts.md) state exact support limits. Public main/release remain
...
The public [research priorities](../research-priorities.md) preserve source
