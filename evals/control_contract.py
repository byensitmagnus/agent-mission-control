#!/usr/bin/env python3
"""Canonical Truth Layer v1 control contract. No agent is launched.

Machine semantics for mission planning, observation and acceptance live here.
Markdown views are human projections. A passing engineering check is not
behavioral PASS and not a release decision.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if argv and argv[0] == "--inspect":
        ...
        return 0
    print("usage: evals/control_contract.py --self-check|--inspect", file=sys.stderr)
    return 2
